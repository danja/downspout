...
The repository currently installs six real wrapper targets:
...
The next install-related validation is host-side confirmation that all six bundles behave correctly in `Release` builds.
