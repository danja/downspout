...
inline constexpr std::array<ParamSpec, kLaneCount * 5> kLaneParamSpecs = {{
    {"lane1_target", "Lane 1 Target", 0.0f, 9.0f, 2.0f, true, false},
    {"lane1_shape", "Lane 1 Shape", 0.0f, static_cast<float>(kShapeCount - 1), 1.0f, true, false},
    {"lane1_rate", "Lane 1 Rate", 0.0f, 1.0f, 0.18f, false, false},
    {"lane1_depth", "Lane 1 Depth", 0.0f, 1.0f, 0.50f, false, false},
    {"lane1_center", "Lane 1 Center", 0.0f, 1.0f, 0.56f, false, false},
    {"lane2_target", "Lane 2 Target", 0.0f, 9.0f, 3.0f, true, false},
    {"lane2_shape", "Lane 2 Shape", 0.0f, static_cast<float>(kShapeCount - 1), 5.0f, true, false},
    {"lane2_rate", "Lane 2 Rate", 0.0f, 1.0f, 0.14f, false, false},
    {"lane2_depth", "Lane 2 Depth", 0.0f, 1.0f, 0.70f, false, false},
    {"lane2_center", "Lane 2 Center", 0.0f, 1.0f, 0.62f, false, false},
    {"lane3_target", "Lane 3 Target", 0.0f, 9.0f, 5.0f, true, false},
    {"lane3_shape", "Lane 3 Shape", 0.0f, static_cast<float>(kShapeCount - 1), 3.0f, true, false},
    {"lane3_rate", "Lane 3 Rate", 0.0f, 1.0f, 0.10f, false, false},
    {"lane3_depth", "Lane 3 Depth", 0.0f, 1.0f, 0.62f, false, false},
    {"lane3_center", "Lane 3 Center", 0.0f, 1.0f, 0.52f, false, false},
    {"lane4_target", "Lane 4 Target", 0.0f, 9.0f, 6.0f, true, false},
    {"lane4_shape", "Lane 4 Shape", 0.0f, static_cast<float>(kShapeCount - 1), 6.0f, true, false},
    {"lane4_rate", "Lane 4 Rate", 0.0f, 1.0f, 0.20f, false, false},
    {"lane4_depth", "Lane 4 Depth", 0.0f, 1.0f, 0.62f, false, false},
    {"lane4_center", "Lane 4 Center", 0.0f, 1.0f, 0.28f, false, false},
}};
...
inline constexpr std::array<ParamSpec, kTriggerCount * 3> kTriggerParamSpecs = {{
    ...
    {"trigger1_rate", "Trigger 1 Rate", 0.0f, 1.0f, 0.32f, false, false},
    {"trigger1_chance", "Trigger 1 Chance", 0.0f, 1.0f, 0.68f, false, false},
    {"trigger2_action", "Trigger 2 Action", 0.0f, 10.0f, 5.0f, true, false},
    {"trigger2_rate", "Trigger 2 Rate", 0.0f, 1.0f, 0.12f, false, false},
    {"trigger2_chance", "Trigger 2 Chance", 0.0f, 1.0f, 0.22f, false, false},
}};
