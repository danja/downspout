...
- **Scale** continuously derives scale runs, triads, or sevenths across one to
  four octaves. With no held notes it uses the selected key's tonic near middle
  C; held notes temporarily replace that internal register anchor.
