...
void Processor::loadScene(const SceneId scene)
{
    ...
    case SceneId::splinter:
        ...
        live_[idx(LiveParamId::chaos)] = 0.18f;
        live_[idx(LiveParamId::noise)] = 0.03f;
        live_[idx(LiveParamId::drift)] = 0.08f;
        live_[idx(LiveParamId::crunch)] = 0.08f;
        live_[idx(LiveParamId::fold)] = 0.10f;
        live_[idx(LiveParamId::delayTime)] = 0.08f;
        live_[idx(LiveParamId::feedback)] = 0.18f;
        live_[idx(LiveParamId::warp)] = 0.08f;
        live_[idx(LiveParamId::stutter)] = 0.10f;
        live_[idx(LiveParamId::tone)] = 0.90f;
        live_[idx(LiveParamId::damping)] = 0.76f;
        live_[idx(LiveParamId::space)] = 0.14f;
        ...
        hidden_[idx(HiddenParamId::pitchSpread)] = 0.10f;
        hidden_[idx(HiddenParamId::delayMix)] = 0.14f;
        hidden_[idx(HiddenParamId::crossFeedback)] = 0.08f;
        hidden_[idx(HiddenParamId::glitchLength)] = 0.08f;
        hidden_[idx(HiddenParamId::chaosRate)] = 0.12f;
        hidden_[idx(HiddenParamId::duck)] = 0.40f;
        break;
    case SceneId::melt:
        live_[idx(LiveParamId::mode)] = 1.0f;
        live_[idx(LiveParamId::damage)] = 0.16f;
        live_[idx(LiveParamId::chaos)] = 0.30f;
        live_[idx(LiveParamId::noise)] = 0.02f;
        live_[idx(LiveParamId::drift)] = 0.24f;
        live_[idx(LiveParamId::crunch)] = 0.04f;
        live_[idx(LiveParamId::fold)] = 0.05f;
        live_[idx(LiveParamId::delayTime)] = 0.34f;
        live_[idx(LiveParamId::feedback)] = 0.40f;
        live_[idx(LiveParamId::warp)] = 0.16f;
        live_[idx(LiveParamId::stutter)] = 0.06f;
        live_[idx(LiveParamId::tone)] = 0.84f;
        live_[idx(LiveParamId::damping)] = 0.64f;
        live_[idx(LiveParamId::space)] = 0.38f;
        live_[idx(LiveParamId::attack)] = 0.04f;
        live_[idx(LiveParamId::release)] = 0.34f;
        live_[idx(LiveParamId::output)] = 0.40f;
        hidden_[idx(HiddenParamId::sourceGain)] = 0.58f;
        hidden_[idx(HiddenParamId::burst)] = 0.52f;
        hidden_[idx(HiddenParamId::pitchSpread)] = 0.30f;
        hidden_[idx(HiddenParamId::delayMix)] = 0.38f;
        hidden_[idx(HiddenParamId::crossFeedback)] = 0.22f;
        hidden_[idx(HiddenParamId::glitchLength)] = 0.12f;
        hidden_[idx(HiddenParamId::chaosRate)] = 0.24f;
        hidden_[idx(HiddenParamId::duck)] = 0.32f;
        break;
    case SceneId::rust:
        live_[idx(LiveParamId::mode)] = 2.0f;
        live_[idx(LiveParamId::damage)] = 0.58f;
        live_[idx(LiveParamId::chaos)] = 0.74f;
        live_[idx(LiveParamId::noise)] = 0.34f;
        live_[idx(LiveParamId::drift)] = 0.18f;
        live_[idx(LiveParamId::crunch)] = 0.68f;
        live_[idx(LiveParamId::fold)] = 0.30f;
        live_[idx(LiveParamId::delayTime)] = 0.12f;
        live_[idx(LiveParamId::feedback)] = 0.34f;
        live_[idx(LiveParamId::warp)] = 0.48f;
        live_[idx(LiveParamId::stutter)] = 0.68f;
        live_[idx(LiveParamId::tone)] = 0.58f;
        live_[idx(LiveParamId::damping)] = 0.42f;
        ...
        hidden_[idx(HiddenParamId::pitchSpread)] = 0.66f;
        hidden_[idx(HiddenParamId::delayMix)] = 0.32f;
        hidden_[idx(HiddenParamId::crossFeedback)] = 0.28f;
        hidden_[idx(HiddenParamId::glitchLength)] = 0.36f;
        hidden_[idx(HiddenParamId::chaosRate)] = 0.78f;
        hidden_[idx(HiddenParamId::duck)] = 0.12f;
        break;
    case SceneId::tunnel:
        live_[idx(LiveParamId::mode)] = 3.0f;
        live_[idx(LiveParamId::damage)] = 0.84f;
        live_[idx(LiveParamId::chaos)] = 0.68f;
        live_[idx(LiveParamId::noise)] = 0.12f;
        live_[idx(LiveParamId::drift)] = 0.34f;
        live_[idx(LiveParamId::crunch)] = 0.38f;
        live_[idx(LiveParamId::fold)] = 0.82f;
        live_[idx(LiveParamId::delayTime)] = 0.64f;
        live_[idx(LiveParamId::feedback)] = 0.86f;
        live_[idx(LiveParamId::warp)] = 0.56f;
        live_[idx(LiveParamId::stutter)] = 0.38f;
        live_[idx(LiveParamId::tone)] = 0.38f;
        live_[idx(LiveParamId::damping)] = 0.58f;
        live_[idx(LiveParamId::space)] = 0.76f;
        live_[idx(LiveParamId::attack)] = 0.02f;
        live_[idx(LiveParamId::release)] = 0.24f;
        live_[idx(LiveParamId::output)] = 0.40f;
        hidden_[idx(HiddenParamId::sourceGain)] = 0.50f;
        hidden_[idx(HiddenParamId::burst)] = 0.64f;
        hidden_[idx(HiddenParamId::pitchSpread)] = 0.42f;
        hidden_[idx(HiddenParamId::delayMix)] = 0.80f;
        hidden_[idx(HiddenParamId::crossFeedback)] = 0.78f;
        hidden_[idx(HiddenParamId::glitchLength)] = 0.74f;
        hidden_[idx(HiddenParamId::chaosRate)] = 0.52f;
        hidden_[idx(HiddenParamId::duck)] = 0.22f;
        break;
    case SceneId::manual:
    default:
        return;
...
{
    const int mode = static_cast<int>(randomUnit() * static_cast<float>(kModeCount)) % static_cast<int>(kModeCount);
    setLiveParameter(LiveParamId::mode, static_cast<float>(mode));

    switch (mode)
    {
    case 0:
        setLiveParameter(LiveParamId::damage, randomRange(0.18f, 0.58f));
        setLiveParameter(LiveParamId::chaos, randomRange(0.06f, 0.38f));
        setLiveParameter(LiveParamId::noise, randomRange(0.0f, 0.16f));
        setLiveParameter(LiveParamId::drift, randomRange(0.0f, 0.18f));
        setLiveParameter(LiveParamId::crunch, randomRange(0.02f, 0.34f));
        setLiveParameter(LiveParamId::fold, randomRange(0.02f, 0.42f));
        setLiveParameter(LiveParamId::attack, randomRange(0.0f, 0.05f));
        setLiveParameter(LiveParamId::release, randomRange(0.04f, 0.18f));
        setHiddenParameter(HiddenParamId::sourceGain, randomRange(0.56f, 0.92f));
        setHiddenParameter(HiddenParamId::burst, randomRange(0.70f, 1.0f));
        setHiddenParameter(HiddenParamId::pitchSpread, randomRange(0.04f, 0.28f));
        setHiddenParameter(HiddenParamId::chaosRate, randomRange(0.06f, 0.32f));
        break;
    case 1:
        setLiveParameter(LiveParamId::damage, randomRange(0.08f, 0.42f));
        setLiveParameter(LiveParamId::chaos, randomRange(0.16f, 0.58f));
        setLiveParameter(LiveParamId::noise, randomRange(0.0f, 0.14f));
        setLiveParameter(LiveParamId::drift, randomRange(0.18f, 0.62f));
        setLiveParameter(LiveParamId::crunch, randomRange(0.0f, 0.20f));
        setLiveParameter(LiveParamId::fold, randomRange(0.0f, 0.24f));
        setLiveParameter(LiveParamId::attack, randomRange(0.01f, 0.10f));
        setLiveParameter(LiveParamId::release, randomRange(0.12f, 0.38f));
        setHiddenParameter(HiddenParamId::sourceGain, randomRange(0.46f, 0.78f));
        setHiddenParameter(HiddenParamId::burst, randomRange(0.34f, 0.76f));
        setHiddenParameter(HiddenParamId::pitchSpread, randomRange(0.04f, 0.36f));
        setHiddenParameter(HiddenParamId::chaosRate, randomRange(0.12f, 0.46f));
        break;
    case 2:
        setLiveParameter(LiveParamId::damage, randomRange(0.35f, 0.86f));
        setLiveParameter(LiveParamId::chaos, randomRange(0.48f, 0.96f));
        setLiveParameter(LiveParamId::noise, randomRange(0.22f, 0.86f));
        setLiveParameter(LiveParamId::drift, randomRange(0.02f, 0.32f));
        setLiveParameter(LiveParamId::crunch, randomRange(0.46f, 0.96f));
        setLiveParameter(LiveParamId::fold, randomRange(0.08f, 0.52f));
        setLiveParameter(LiveParamId::attack, randomRange(0.0f, 0.08f));
        setLiveParameter(LiveParamId::release, randomRange(0.04f, 0.24f));
        setHiddenParameter(HiddenParamId::sourceGain, randomRange(0.54f, 0.96f));
        setHiddenParameter(HiddenParamId::burst, randomRange(0.62f, 1.0f));
        setHiddenParameter(HiddenParamId::pitchSpread, randomRange(0.30f, 0.92f));
        setHiddenParameter(HiddenParamId::chaosRate, randomRange(0.54f, 0.96f));
        break;
    case 3:
        setLiveParameter(LiveParamId::damage, randomRange(0.52f, 1.0f));
        setLiveParameter(LiveParamId::chaos, randomRange(0.28f, 0.78f));
        setLiveParameter(LiveParamId::noise, randomRange(0.0f, 0.22f));
        setLiveParameter(LiveParamId::drift, randomRange(0.08f, 0.46f));
        setLiveParameter(LiveParamId::crunch, randomRange(0.02f, 0.34f));
        setLiveParameter(LiveParamId::fold, randomRange(0.46f, 1.0f));
        setLiveParameter(LiveParamId::attack, randomRange(0.01f, 0.12f));
        setLiveParameter(LiveParamId::release, randomRange(0.18f, 0.52f));
        setHiddenParameter(HiddenParamId::sourceGain, randomRange(0.40f, 0.76f));
        setHiddenParameter(HiddenParamId::burst, randomRange(0.30f, 0.70f));
        setHiddenParameter(HiddenParamId::pitchSpread, randomRange(0.16f, 0.58f));
        setHiddenParameter(HiddenParamId::chaosRate, randomRange(0.18f, 0.60f));
        break;
    case 4:
        setLiveParameter(LiveParamId::damage, randomRange(0.20f, 0.66f));
        setLiveParameter(LiveParamId::chaos, randomRange(0.16f, 0.62f));
        setLiveParameter(LiveParamId::noise, randomRange(0.0f, 0.20f));
        setLiveParameter(LiveParamId::drift, randomRange(0.0f, 0.28f));
        setLiveParameter(LiveParamId::crunch, randomRange(0.0f, 0.28f));
        setLiveParameter(LiveParamId::fold, randomRange(0.40f, 1.0f));
        setLiveParameter(LiveParamId::attack, randomRange(0.0f, 0.08f));
        setLiveParameter(LiveParamId::release, randomRange(0.06f, 0.34f));
        setHiddenParameter(HiddenParamId::sourceGain, randomRange(0.48f, 0.86f));
        setHiddenParameter(HiddenParamId::burst, randomRange(0.46f, 0.90f));
        setHiddenParameter(HiddenParamId::pitchSpread, randomRange(0.45f, 1.0f));
        setHiddenParameter(HiddenParamId::chaosRate, randomRange(0.06f, 0.44f));
        break;
    default:
        setLiveParameter(LiveParamId::damage, randomRange(0.04f, 0.38f));
        setLiveParameter(LiveParamId::chaos, randomRange(0.18f, 0.66f));
        setLiveParameter(LiveParamId::noise, randomRange(0.04f, 0.34f));
        setLiveParameter(LiveParamId::drift, randomRange(0.22f, 0.74f));
        setLiveParameter(LiveParamId::crunch, randomRange(0.0f, 0.18f));
        setLiveParameter(LiveParamId::fold, randomRange(0.0f, 0.24f));
        setLiveParameter(LiveParamId::attack, randomRange(0.04f, 0.18f));
        setLiveParameter(LiveParamId::release, randomRange(0.24f, 0.62f));
        setHiddenParameter(HiddenParamId::sourceGain, randomRange(0.36f, 0.72f));
        setHiddenParameter(HiddenParamId::burst, randomRange(0.18f, 0.58f));
        setHiddenParameter(HiddenParamId::pitchSpread, randomRange(0.16f, 0.58f));
        setHiddenParameter(HiddenParamId::chaosRate, randomRange(0.08f, 0.38f));
        break;
    }
    reseedEngine();
}
...
{
    setLiveParameter(LiveParamId::delayTime, randomRange(0.04f, 0.70f));
    setLiveParameter(LiveParamId::feedback, randomRange(0.18f, 0.88f));
    setLiveParameter(LiveParamId::warp, randomRange(0.05f, 0.74f));
    setLiveParameter(LiveParamId::stutter, randomRange(0.06f, 0.76f));
    setLiveParameter(LiveParamId::tone, randomRange(0.34f, 0.94f));
    setLiveParameter(LiveParamId::damping, randomRange(0.28f, 0.80f));
    setLiveParameter(LiveParamId::space, randomRange(0.18f, 0.86f));
    setHiddenParameter(HiddenParamId::delayMix, randomRange(0.18f, 0.80f));
    setHiddenParameter(HiddenParamId::crossFeedback, randomRange(0.10f, 0.78f));
    setHiddenParameter(HiddenParamId::glitchLength, randomRange(0.10f, 0.74f));
    setHiddenParameter(HiddenParamId::duck, randomRange(0.10f, 0.55f));
}
