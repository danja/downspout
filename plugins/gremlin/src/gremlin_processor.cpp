...
void Processor::loadScene(const SceneId scene)
{
    ...
    case SceneId::melt:
        ...
        live_[idx(LiveParamId::damage)] = 0.22f;
        live_[idx(LiveParamId::chaos)] = 0.38f;
        live_[idx(LiveParamId::noise)] = 0.04f;
        live_[idx(LiveParamId::drift)] = 0.34f;
        live_[idx(LiveParamId::crunch)] = 0.06f;
        live_[idx(LiveParamId::fold)] = 0.08f;
        live_[idx(LiveParamId::delayTime)] = 0.30f;
        live_[idx(LiveParamId::feedback)] = 0.36f;
        live_[idx(LiveParamId::warp)] = 0.20f;
        live_[idx(LiveParamId::stutter)] = 0.08f;
        live_[idx(LiveParamId::tone)] = 0.78f;
        live_[idx(LiveParamId::damping)] = 0.64f;
        live_[idx(LiveParamId::space)] = 0.32f;
        live_[idx(LiveParamId::attack)] = 0.04f;
        live_[idx(LiveParamId::release)] = 0.28f;
        live_[idx(LiveParamId::output)] = 0.40f;
        hidden_[idx(HiddenParamId::sourceGain)] = 0.62f;
        hidden_[idx(HiddenParamId::burst)] = 0.58f;
        hidden_[idx(HiddenParamId::pitchSpread)] = 0.18f;
        hidden_[idx(HiddenParamId::delayMix)] = 0.32f;
        hidden_[idx(HiddenParamId::crossFeedback)] = 0.18f;
    ...
    case SceneId::rust:
        ...
        live_[idx(LiveParamId::damage)] = 0.42f;
        live_[idx(LiveParamId::chaos)] = 0.62f;
        live_[idx(LiveParamId::noise)] = 0.24f;
        live_[idx(LiveParamId::drift)] = 0.18f;
        live_[idx(LiveParamId::crunch)] = 0.46f;
        live_[idx(LiveParamId::fold)] = 0.18f;
        live_[idx(LiveParamId::delayTime)] = 0.12f;
        live_[idx(LiveParamId::feedback)] = 0.26f;
        live_[idx(LiveParamId::warp)] = 0.34f;
        live_[idx(LiveParamId::stutter)] = 0.54f;
        live_[idx(LiveParamId::tone)] = 0.62f;
        live_[idx(LiveParamId::damping)] = 0.48f;
        live_[idx(LiveParamId::space)] = 0.30f;
        live_[idx(LiveParamId::attack)] = 0.01f;
        ...
        hidden_[idx(HiddenParamId::pitchSpread)] = 0.52f;
        hidden_[idx(HiddenParamId::delayMix)] = 0.24f;
        hidden_[idx(HiddenParamId::crossFeedback)] = 0.18f;
        hidden_[idx(HiddenParamId::glitchLength)] = 0.20f;
        hidden_[idx(HiddenParamId::chaosRate)] = 0.62f;
        hidden_[idx(HiddenParamId::duck)] = 0.18f;
        break;
    case SceneId::tunnel:
        live_[idx(LiveParamId::mode)] = 3.0f;
        live_[idx(LiveParamId::damage)] = 0.58f;
        live_[idx(LiveParamId::chaos)] = 0.48f;
        live_[idx(LiveParamId::noise)] = 0.08f;
        live_[idx(LiveParamId::drift)] = 0.22f;
        live_[idx(LiveParamId::crunch)] = 0.12f;
        live_[idx(LiveParamId::fold)] = 0.46f;
        live_[idx(LiveParamId::delayTime)] = 0.58f;
        live_[idx(LiveParamId::feedback)] = 0.72f;
        live_[idx(LiveParamId::warp)] = 0.44f;
        live_[idx(LiveParamId::stutter)] = 0.18f;
        live_[idx(LiveParamId::tone)] = 0.46f;
        live_[idx(LiveParamId::damping)] = 0.74f;
        live_[idx(LiveParamId::space)] = 0.70f;
        live_[idx(LiveParamId::attack)] = 0.02f;
        live_[idx(LiveParamId::release)] = 0.24f;
        live_[idx(LiveParamId::output)] = 0.40f;
        hidden_[idx(HiddenParamId::sourceGain)] = 0.54f;
        hidden_[idx(HiddenParamId::burst)] = 0.48f;
        hidden_[idx(HiddenParamId::pitchSpread)] = 0.24f;
        hidden_[idx(HiddenParamId::delayMix)] = 0.66f;
        hidden_[idx(HiddenParamId::crossFeedback)] = 0.58f;
        hidden_[idx(HiddenParamId::glitchLength)] = 0.46f;
        hidden_[idx(HiddenParamId::chaosRate)] = 0.28f;
        hidden_[idx(HiddenParamId::duck)] = 0.44f;
        break;
    case SceneId::manual:
    default:
        return;
...
void Processor::randomizeSource()
{
    ...
    case 1:
        ...
        break;
    case 2:
        setLiveParameter(LiveParamId::damage, randomRange(0.24f, 0.72f));
        setLiveParameter(LiveParamId::chaos, randomRange(0.38f, 0.88f));
        setLiveParameter(LiveParamId::noise, randomRange(0.16f, 0.72f));
        setLiveParameter(LiveParamId::drift, randomRange(0.02f, 0.32f));
        setLiveParameter(LiveParamId::crunch, randomRange(0.32f, 0.86f));
        setLiveParameter(LiveParamId::fold, randomRange(0.0f, 0.42f));
        ...
        setHiddenParameter(HiddenParamId::pitchSpread, randomRange(0.22f, 0.82f));
        setHiddenParameter(HiddenParamId::chaosRate, randomRange(0.42f, 0.90f));
        break;
    case 3:
        setLiveParameter(LiveParamId::damage, randomRange(0.40f, 0.90f));
        setLiveParameter(LiveParamId::chaos, randomRange(0.20f, 0.68f));
        setLiveParameter(LiveParamId::noise, randomRange(0.0f, 0.22f));
        setLiveParameter(LiveParamId::drift, randomRange(0.08f, 0.46f));
        setLiveParameter(LiveParamId::crunch, randomRange(0.02f, 0.34f));
        setLiveParameter(LiveParamId::fold, randomRange(0.32f, 0.88f));
        ...
        setHiddenParameter(HiddenParamId::pitchSpread, randomRange(0.10f, 0.48f));
        setHiddenParameter(HiddenParamId::chaosRate, randomRange(0.12f, 0.48f));
        break;
    case 4:
        ...
        setLiveParameter(LiveParamId::fold, randomRange(0.34f, 0.92f));
        setLiveParameter(LiveParamId::attack, randomRange(0.0f, 0.08f));
        ...
        setHiddenParameter(HiddenParamId::pitchSpread, randomRange(0.32f, 0.96f));
