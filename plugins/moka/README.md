...
The DPF wrapper (`src/dpf/MokaPlugin.cpp`) exposes eight automatable
parameters; the UI (`src/dpf/MokaUI.cpp`) follows the shared Cold War
test-equipment look & feel with dark/light panel themes and a ten-entry
factory preset menu.
...
|---|------|-------|---------|-------|
| 0 | Instrument | Xylophone…Tube | Xylophone | Selects the modal table |
| 1 | Decay | 0–100 % | 55 % | Overall resonance time, 0.15x–3x |
| 2 | Mallet | 0–100 % | 65 % | Beater hardness: partial brightness + click |
| 3 | Tone | 0–100 % | 60 % | Resonator lowpass |
| 4 | Spread | 0–100 % | 30 % | Inharmonic stretch of partial ratios |
