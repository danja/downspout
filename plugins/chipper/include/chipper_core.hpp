...
// Default CC assignments match Drift lanes 1 and 2.
...
// effectiveBitDepth / effectiveRateDiv: use CC-overridden values when active,
// otherwise fall back to params.bitDepth / params.rateDiv.
